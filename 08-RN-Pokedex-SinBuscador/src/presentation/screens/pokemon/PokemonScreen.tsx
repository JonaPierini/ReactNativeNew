...
//Aca toma las props por parametros
...
export const PokemonScreen = ({navigation, route}: Props) => {
  ...
  //Aca como pasa por parametro el ID lo que se hace es una nueva peticion http para traer esa data especifica
  //SE puede hacer pasando desde la card todo el objeto del pokemon y aca directamente renderizar
  const {isLoading, data: pokemon} = useQuery({
    queryKey: ['pokemon', pokemonId],
    queryFn: () => getPokemonById(pokemonId),
    //POR UNA HORA NO SE HACE LA PETICION HTTP
